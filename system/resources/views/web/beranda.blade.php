            ...
            <div class="tp-banner">
                <ul>
                    ...
                    @foreach ($list_slider as $item)
                        ...
                        data-endspeed="1200"
                        data-endeasing="Power4.easeIn"><div style="font-size: 36px" class="subtitle-text">{{$item['judul']}}</div></div>
                        ...
                        data-endelementdelay="0.3"
                        data-endspeed="1200"
                        data-endeasing="Power4.easeIn"><h2 style="font-size: 20px">{{$item['deskripsi']}}</h2></div>
